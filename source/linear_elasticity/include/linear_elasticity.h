...
namespace Linear_Elasticity
{
  ...
  private:
    ...
    Point<dim> force_top;
    Point<dim> force_bot;
    Point<dim> attachment_point_top;
    Point<dim> attachment_point_bot;
    ...
    std::vector<types::global_dof_index> attchmntpnt_top_dof_idx;
    std::vector<types::global_dof_index> attchmntpnt_bot_dof_idx;
    std::vector<types::global_dof_index> clamped_dof_idx;
